...
export default class BaiTapThuKinh extends Component {
    ...
    renderKinhComponent = this.productGlasses.arrGlasses.map(
        (glassesItem, index) => {
            return (
            ...
            >
                ...
                <div style={{ backgroundColor: "rgba(0,0,0,0.4)", height: "100%" }}>
                    <h3
                        ...
                        style={{ backgroundColor: "rgba(0,0,0,0.3)", height: "150px" }}
                    >
                        TRY GALSSES APP ONLINE
                    </h3>
                        ...
                        <div className="row mt-5 text-center">
                            <div className="col-6">
                                <div className="position-relative">
                                    ...
                                    <div
                                        className="position-absolute text-left text-white m-0"
                                        style={infoGlasses}
                                    >
                    ...
                    <div className="container mt-5" style={{ backgroundColor: "#fff" }}>
                        <div className="row">{this.renderKinhComponent}</div>
                    </div>
                </div>
            </div>
        );
